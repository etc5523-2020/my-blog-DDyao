...
Base on the table\@ref(tab:province), in the ten provinces of France.The situation is most serious is French local , which has 314899 case. The second is French Guiana, which has 14228 cases.And the least is Saint pierre and Miquelon, which only has 5 cases.
